<template>
  ...
  <div class="Mirle21Search mt-2">
    <h4 class="fw-bold">K21盟立異常查詢</h4>
...
export default {
  ...
  methods: {
    historySearch(str) {
      ...
      this.isLoading = true;
      const api = `${process.env.VUE_APP_CIM_ESERVICES_MIRLE21_ALARM_API_URL}/mirle21_alarm_data?startTime=${this.historyStartTime}&endTime=${this.historyEndTime}`;
      this.$http
        .get(api)
        .then((res) => {
          if (res.data.success) {
