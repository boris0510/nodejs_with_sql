<template>
  ...
  <div class="MuratecAlarmSearch mt-2">
    <h4 class="fw-bold">B5村田異常查詢</h4>
    <div class="d-flex align-items-center mb-3">
      ...
      <!-- <ExportToExcel v-show="historyData.length !== 0" /> -->
    </div>
    <hr />
    <h4
...
export default {
  ...
  methods: {
    historySearch(str) {
      ...
      this.isLoading = true;
      const api = `${process.env.VUE_APP_CIM_ESERVICES_MURATEC_ALARM_API_URL}/muratec_alarm_data_report?startTime=${this.historyStartTime}&endTime=${this.historyEndTime}`;
      this.$http
        .get(api)
        .then((res) => {
          if (res.data.success) {
            ...
            // const fileName = `muratec_alarm_data${tempTime}_(Security C)`;
            // this.emitter.emit('excel:data', { fileName, columns: this.columns, historyData: this.historyData });
